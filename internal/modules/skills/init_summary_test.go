...
func TestInitCatalogStatsFrom(t *testing.T) {
	catalog := &FetchedSkills{
		...
		Skills: []Skill{
			{Identifier: "a", Title: "Skill A", Version: "2.0.0", CreatedBy: "user-a", GroupIDs: []string{"g1"}},
			{Identifier: "b", Title: "Skill B", Version: "1.0.0", CreatedBy: "user-b", GroupIDs: []string{"g1"}},
			{Identifier: "c", Title: "Skill C", Version: "3.0.0", CreatedBy: "user-c", GroupIDs: []string{"g2"}},
			{Identifier: "solo", Title: "Solo", Version: "1.0.0", CreatedBy: "user-solo"},
		},
	}
	...
	if len(stats.Groups[0].Skills) != 2 || stats.Groups[0].Skills[0].Version != "2.0.0" || stats.Groups[0].Skills[0].CreatedBy != "user-a" {
